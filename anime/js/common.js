...
var SinMH = function ($) {
    ...
    function getChapterImage(page) {		
		...
		console.log(filename.match(/^https?:\/\/(manhua.qpic.cn)/i));
		if (filename.match(/^https?:\/\/(manhua.qpic.cn)/i)) return 'https://manga.mipcdn.com/i/s/'+encodeURI(filename);
		console.log(filename.match(/^https?:\/\/(mhimg.eshanyao.com)/i));
        if (filename.match(/^https?:\/\/(mhimg.eshanyao.com)/i)) return 'https://manga.mipcdn.com/i/s/'+encodeURI(filename);
        console.log(filename.match(/^https?:\/\/(dd.wstts.com)/i));
        if (filename.match(/^https?:\/\/(dd.wstts.com)/i)) return 'https://manga.mipcdn.com/i/s/'+encodeURI(filename);
